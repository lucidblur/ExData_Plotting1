...
png("plot4.png")
## Set parameters for the four plots
par(mar = c(3.1,4.1,4.1,2.1), mfrow = c(2,2))
...
## Voltage Plot
plot(consumption$Date, consumption$Voltage,
     type = "l", ylab = "Voltage", main = NULL)
...
plot(consumption$Date, consumption$Global_reactive_power, 
